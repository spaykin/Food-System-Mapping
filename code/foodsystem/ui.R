        ...
        sidebarLayout(
            sidebarPanel(
                selectInput(
                    "maps",
                    h4("Explore Data:"),
                    choices = c("Agricultural Value Chain",
                                "Health",
                                "Community",
                                "Cropland")
                ),
            ...
            mainPanel(
                conditionalPanel(condition = "input.maps == 'Agricultural Value Chain'",
                                 leafletOutput("mapValueChain")),
                
                conditionalPanel(condition = "input.maps == 'Health'",
                                 leafletOutput("mapHealth")),
                
                conditionalPanel(condition = "input.maps == 'Community'",
